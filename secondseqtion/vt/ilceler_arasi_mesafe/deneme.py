...
# Batch'leri işleyip dosyalara yazma
for i in range(0, len(df), batch_size):
    ...
    # Yeni dosya her 100 batch'te bir oluşturulacak
    batch_count += 1
    file_number = (batch_count - 1) // 100 + 1  # Her 100 batch için yeni dosya
    file_name = f"ilceler_arasi_mesafe_insert_{file_number}.sql"

    # SQL insert komutunu dosyaya yaz
    with open(file_name, "a", encoding="utf-8") as f:
        insert_statement = f"INSERT INTO {table_name} {columns} VALUES\n{values};\n"
        f.write(insert_statement)

print("SQL scripts created successfully!")
