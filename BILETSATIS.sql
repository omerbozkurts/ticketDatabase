...
GO
	...
	CREATE TABLE FIRMA(
		...
		FIRMAILKODU CHAR(2) FOREIGN KEY REFERENCES IL(ILKODU) ON DELETE SET DEFAULT ON UPDATE SET DEFAULT CONSTRAINT notNullFirmaIl NOT NULL,
		FIRMAILCEKODU INT FOREIGN KEY REFERENCES ILCE(ILCEID) ON DELETE SET DEFAULT ON UPDATE SET DEFAULT CONSTRAINT notNullFirmaIlce NOT NULL
	)
...
GO
	...
	CREATE TABLE PERSONEL(
		...
		DOGUMICLE INT FOREIGN KEY REFERENCES ILCE(ILCEID) NOT NULL,
...
GO
	...
	CREATE TABLE ARACTUR(
		...
		ARACTURAD CHAR(1) CONSTRAINT checkAracTurAd CHECK(ARACTURAD LIKE '[O][U][G][T]') 
						  CONSTRAINT notNullAracTurAd NOT NULL,-- O: OTOBUS, U:UCAK, G:GEMI, T:TREN
	)
...
GO 
	CREATE TABLE DURAKLAR(
		...
		DURAKTUR CHAR(1) CONSTRAINT chkDurakTur CHECK(DURAKTUR LIKE '[O][G][H][L]'), -- O: OTOGAR,G: TREN GARI,H: HAVAALANI,L:LIMAN
...
GO
	...
	CREATE TABLE SEFER(
		...
		PERSONEL INT FOREIGN KEY REFERENCES PERSONEL(PERSONELID)
							  CONSTRAINT notNullSeferPersonel NOT NULL,
		GUZERGAH INT FOREIGN KEY REFERENCES GUZERGAH(GUZERGAHID)
		...
		UGRANILANDURAKLAR INT FOREIGN KEY REFERENCES UGRANILANDURAK(UGRANILANDURAKID)
										  CONSTRAINT notNullSeferUgranilan NOT NULL,
		ARAC INT FOREIGN KEY REFERENCES ARAC(ARACID)
